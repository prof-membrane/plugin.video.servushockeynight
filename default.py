...
def MAIN():
	checklastrun()
	if __settings__.getSetting('league') == "0":
		LIGA("del","del")
	elif __settings__.getSetting('league') == "1":
		LIGA("ebel","ebel")
	else:
...
def PLAY(url,name):#10
	...
	dialog.update(33, __language__(30612))
	...
	dialog.update(66, __language__(30613))
